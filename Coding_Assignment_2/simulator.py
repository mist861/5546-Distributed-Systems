...
class Message(object):
    def __init__(self, message_id, src, dest, mtype, send_id, proposed_id, payload=None):
        self.message_id = message_id
        self.src = src
        self.dest = dest
        self.mtype = mtype
        self.send_id = send_id # This was updated with a send ID (for FIFO)
        self.proposed_id = proposed_id # And a proposed ID (for TO)
